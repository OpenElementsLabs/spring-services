...
public class Tests {
    ...
    void testSaveNewHasReallySaved() {
        ...
        Assertions.assertEquals(saved, forTestDataService.findAll(Pageable.unpaged()).stream().findAny().orElseThrow());
    ...
    void testSaveUpdate() {
        ...
        Assertions.assertEquals(updated, forTestDataService.findAll(Pageable.unpaged()).stream().findAny().orElseThrow());
    ...
    void testDeleteNull() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> forTestDataService.delete(nullString));
    ...
    void testDeleteUnknown() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> forTestDataService.delete(nullID));
        Assertions.assertThrows(IllegalArgumentException.class, () -> forTestDataService.delete(nullDto));
    }
