...
class UserServiceTest {
    ...
    private final UserService userService = new UserService(userRepository, eventPublisher, authService);
    ...
    class GetCurrentUserTest {
        ...
        void shouldReturnExistingUserWithoutSaving() {
            ...
            final UserEntity existing = createExistingUser("auth0|existing", "Same Name", "same@example.com");
        ...
        void shouldUpdateExistingUserWhenNameChanged() {
            ...
            final UserEntity existing = createExistingUser("auth0|updated", "Old Name", "same@example.com");
