...
class AuthServiceTest {
    ...
    class GetPrincipalJwtTest {
        ...
        void shouldThrowWhenPrincipalIsNotJwt() {
            //GIVEN
            final TestingAuthenticationToken auth = new TestingAuthenticationToken("stringPrincipal", "pass");
            SecurityContextHolder.getContext().setAuthentication(auth);
    ...
    class GetPrincipalTest {
        ...
        void shouldReturnAuthenticatedPrincipalDirectly() {
            ...
            final TestingAuthenticationToken auth = new TestingAuthenticationToken(directPrincipal, "pass");
            SecurityContextHolder.getContext().setAuthentication(auth);
