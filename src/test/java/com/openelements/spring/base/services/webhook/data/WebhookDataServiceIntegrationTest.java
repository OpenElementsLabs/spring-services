...
class WebhookDataServiceIntegrationTest {
    ...
    class SaveTest {
        ...
        void shouldCreateNewWebhook() {
            //GIVEN
            final WebhookDto dto = new WebhookDto(UUID.randomUUID(), "https://example.com/hook", true, null, null);
    ...
    class FindAllActiveTest {
        ...
        void shouldReturnOnlyActiveWebhooks() {
            //GIVEN
            webhookDataService.save(new WebhookDto(UUID.randomUUID(), "https://active1.com/hook", true, null, null));
            webhookDataService.save(new WebhookDto(UUID.randomUUID(), "https://active2.com/hook", true, null, null));
            webhookDataService.save(new WebhookDto(UUID.randomUUID(), "https://inactive.com/hook", false, null, null));
            ...
            assertThat(active).extracting(WebhookDto::url)
    ...
    class GetAllTest {
        ...
        void shouldReturnAllWebhooks() {
            //GIVEN
            webhookDataService.save(new WebhookDto(UUID.randomUUID(), "https://hook1.com", true, null, null));
            webhookDataService.save(new WebhookDto(UUID.randomUUID(), "https://hook2.com", false, null, null));
    ...
    class FindByIdTest {
        ...
        void shouldFindExistingWebhook() {
            //GIVEN
            final WebhookDto saved = webhookDataService.save(
