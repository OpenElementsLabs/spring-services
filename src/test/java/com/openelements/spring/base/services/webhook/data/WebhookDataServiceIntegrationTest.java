...
class WebhookDataServiceIntegrationTest {
    ...
    class FindAllActiveTest {
        ...
        void shouldReturnOnlyActiveWebhooks() {
            ...
            webhookDataService.save(
                    new WebhookDto(null, "https://active1.com/hook", true, null, null));
            webhookDataService.save(
                    new WebhookDto(null, "https://active2.com/hook", true, null, null));
            webhookDataService.save(
                    new WebhookDto(null, "https://inactive.com/hook", false, null, null));
    ...
    class GetAllTest {
        ...
        void shouldReturnAllWebhooks() {
            // GIVEN
            webhookDataService.save(
                    new WebhookDto(null, "https://hook1.com", true, null, null));
            webhookDataService.save(
                    new WebhookDto(null, "https://hook2.com", false, null, null));
