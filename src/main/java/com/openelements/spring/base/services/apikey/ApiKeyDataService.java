...
public class ApiKeyDataService {
    ...
    public ApiKeyDataService(@NonNull final ApiKeyRepository apiKeyRepository, @NonNull final UserService userService) {
        this.apiKeyRepository =
                Objects.requireNonNull(apiKeyRepository, "apiKeyRepository must not be null");
    ...
    public void delete(final UUID id) {
        ...
        final ApiKeyEntity entity =
                apiKeyRepository
                        .findById(id)
                        .orElseThrow(
                                () ->
                                        new ResponseStatusException(HttpStatus.NOT_FOUND, "API key not found: " + id));
