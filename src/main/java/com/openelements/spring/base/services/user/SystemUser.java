 ...
 * used as the actor reference for operations that have no authenticated principal (scheduled tasks,
 * startup data loads, API-key requests, etc.).
 *
 * <p>The System User row is created on application startup by {@link SystemUserInitializer} and is
 * guaranteed to exist for the lifetime of the application.
 */
