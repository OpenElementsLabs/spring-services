...
public class AuditLogDataService extends AbstractDbBackedDataService<AuditLogEntity, AuditLogDto> {
   ...
   * first).
   *
   * @param userId the id of the user (use {@link SystemUser#ID} for unauthenticated actors)
   * @param pageable pagination information
   * @return matching entries as a page of DTOs
   */
  ...
  /**
   * Returns all audit entries created on the given calendar day, ordered by creation time (oldest
   * first).
   *
