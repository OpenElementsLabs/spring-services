 ...
 */
public record WebhookDataEventPayload<T extends WithId>(UUID eventId,
                                                        WebhookDataEventType eventType,
                                                        Class<T> dataClass,
                                                        T data,
                                                        Instant timestamp
    ...
    public static <T extends WithId> WebhookDataEventPayload<T> of(WebhookDataEventType eventType, Class<T> dataclass, T data) {
        Objects.requireNonNull(data, "data must not be null");
        return new WebhookDataEventPayload<>(UUID.randomUUID(), eventType, dataclass, data, Instant.now());
    }

    public static <T extends WithId> WebhookDataEventPayload<T> of(WebhookDataEventType eventType, T data) {
        Objects.requireNonNull(data, "data must not be null");
